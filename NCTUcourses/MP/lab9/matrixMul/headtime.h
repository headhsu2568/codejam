 ...
 * long long int exec_time_sec;
 * long long int exec_time_nsec;
 ***/
...
inline void ComputeTime_rusage(struct rusage* start_time,struct rusage* end_time,long long int* exec_time_sec,long long int* exec_time_usec){
    ...
    printf("ssec:%lld   susec:%lld\n",(long long int)start_time->ru_utime.tv_sec, (long long int)start_time->ru_utime.tv_usec);
    printf("esec:%lld   eusec:%lld\n",(long long int)end_time->ru_utime.tv_sec, (long long int)end_time->ru_utime.tv_usec);
    return;
}
 ...
 * unsigned long long int end_clock;
 * unsigned long long int exec_clock;
 ***/
#define rdtsc(low,high) __asm__ __volatile__("rdtsc" : "=a" (low), "=d" (high))
#define rdtscll(val) __asm__ __volatile__("rdtsc" : "=A" (val))
inline void GetTime_rdtsc(unsigned long long int*);
inline void ComputeTime_rdtsc(unsigned long long int*,unsigned long long int*,unsigned long long int*);
inline void ShowTime_rdtsc(unsigned long long int*);

inline void GetTime_rdtsc(unsigned long long int* get_clock){
    rdtscll(get_clock);
    return;
}
inline void ComputeTime_rdtsc(unsigned long long int* start_clock,unsigned long long int* end_clock,unsigned long long int* exec_clock){
    *exec_clock+=*end_clock-*start_clock;
    return;
}
inline void ShowTime_rdtsc(unsigned long long int* exec_clock){
